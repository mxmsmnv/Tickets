...
$checks = [
	...
	'internal note colors the complete row' => str_contains($css, '.TicketsMessage[data-author="internal"] {')
		&& !str_contains($css, '.TicketsMessage[data-author="internal"] .TicketsMessage-content {'),

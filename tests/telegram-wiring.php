...
$checks = [
	...
	'TeleWire dependency' => str_contains($module, "'TeleWire>=1.0.2'") && str_contains($integration, "method_exists(\$telewire, 'createClient')"),
	'credential-scoped transport' => str_contains($integration, '$telewire->createClient($this->telegramBotToken()') && str_contains($integration, '$client->sendMessage($chatId'),
	'no direct transport' => !str_contains($integration, 'curl_init') && !str_contains($integration, 'api.telegram.org'),
